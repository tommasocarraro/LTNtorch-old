...
def main():
    ...
    # Note that the given seed allows to numpy to generate very distant clusters. In this way, LTN is helped in the
    # training. It is probable that if you change the seed, LTN will make some mistakes while identifying clusters.
    # This depends on how much the clusters are distinct and on the number of outliers generated by the random process.
